...
for (let item of coursesArray) {
    ...
    month.classList.add('duration');
    month.innerHTML = `<h3>${item.monthDuration} months</h3>`;
    let hour = document.createElement('div');
    hour.classList.add('duration');
    hour.innerHTML = `<h3>${item.monthDuration} hours</h3>`;
    ...
    container.append(title, month, hour, modules);
}